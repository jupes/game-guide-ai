...
// had never rendered SpellCard against the dark palette at all. That is exactly
...
export const Dark: Story = { ...Fireball, globals: { theme: 'dark' } }

export const DarkConcentrationRitual: Story = {
  ...ConcentrationRitual,
  globals: { theme: 'dark' },
}
